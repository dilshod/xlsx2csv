...
def convert_and_upload(bq_dest, local_source, c_storage_source):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--local-source', dest='local_source', default=None,
                        help='The local directory source: /path/to/directory')
    parser.add_argument('-c', '--cloud-source', dest='cloud_source', default=None,
                        help='The cloud storage source: gs://bucket/path')
